...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/TouchInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @TouchInput: IInputActionCollection2, IDisposable
{
    ...
    ~@TouchInput()
    {
        UnityEngine.Debug.Assert(!m_control.enabled, "This will cause a leak and performance issues, TouchInput.control.Disable() has not been called.");
    }
    ...
    public struct ControlActions
    {
        ...
        /// </summary>
        public ControlActions(@TouchInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
